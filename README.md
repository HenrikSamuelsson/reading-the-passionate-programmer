...
There is a saying called Parkinsons Law:

> “Work expands so as to fill the time available for it scompletion

If you have time you tend to fill up the time, if yo do not have time your are forced to prioritize.

By keeping focus on what can be done right now we can move faster and fight Parkinsons law.
